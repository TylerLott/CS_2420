...
// void checkBalance()    --> Check is tree is balanced
...
public class AVLTree<AnyType extends Comparable<? super AnyType>>
{
    ...
    /**
     * Find the min item in the tree and delete, then rebalance the tree.
     */
    ...
    /**
     * Internal method to find the smallest item in subtree, delete, then rebalance the tree
    ...
    private AvlNode<AnyType> deleteMin( AvlNode<AnyType> t )
    {
        ...
        if ( t.left == findMin( t )) {
            t.left = (t.left.right != null) ? t.left = findMin( t.left.right ) : null;
        }
        if (t.left != null) {
            deleteMin(t.left);
        }
